...
На главной странице можно вставить до 1 000 000 символов текста и получить публичную ссылку. Вставки хранятся отдельно от Obsidian в `data/pastes` и автоматически удаляются через 12 часов.
